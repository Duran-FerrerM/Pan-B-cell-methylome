...
For NGS-based DNA methylaion data, a new strategy was developed in *Knisbacher, Lin, Hahn, Nadeu, Duran-Ferrer et al. Molecular map of chronic lymphocytic leukemia and its impact on outcome, 2022, accepted*. (new tutorial comming soon!). Briefly, an extended epiCMIT-CpG catalogue was found using Whole Genome Bisulphite data and is systematically searched in each sample separately, irrespective of CpG numbers and identity. All epiCMIT-CpG set behaves very similar and thus can be applied.
