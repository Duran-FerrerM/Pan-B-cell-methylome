...
download.file("https://github.com/Duran-FerrerM/Pan-B-cell-methylome/raw/master/Estimate.epiCMIT.v.2.RData", destfile = "Estimate.epiCMIT.v.2.RData", method="libcurl")
load("Estimate.epiCMIT.v.2.RData")
file.remove("Estimate.epiCMIT.v.2.RData")
