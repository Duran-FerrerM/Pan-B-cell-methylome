...
A complete tutorial to estimate cellular composition for your 450k/EPIC DNA methylation data as well as to predict the main B-cell tumor entities and subtypes can be found [here](https://duran-ferrerm.github.io/B.cell.tumor.classifier.html).
